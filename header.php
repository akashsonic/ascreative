...
<div id="header">
<!-- Logo start -->
<div class="main-logo"><button type="button" class="navbar-toggle collapsed"   aria-expanded="false" aria-controls="navbar">
              <span class="sr-only">Toggle navigation</span>
              <span class="icon-bar"></span>
              <span class="icon-bar"></span>
              <span class="icon-bar"></span>
            </button><a href="<?php echo get_site_url();?>"><img src="<?php echo get_custom_data('upload_header_logo');?>" /></a></div>
           <!-- Logo end -->
           <!-- Menu start -->
            <div class="menu-nav">
<?php	
